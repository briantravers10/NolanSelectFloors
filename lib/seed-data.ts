...
export function buildSeedData() {
  ...
  const projectBaseSeeds = [
    ...
    { id: "p-4", company_id: COMPANY_ID, building_id: "b-6", unit_number: "8A", name: "Unit 8A — Hardwood Installation", description: "New 3/4in white oak hardwood, 650 sq ft, board install after subfloor check.", status: "Materials Ordered", project_value: 9100, other_cost: 200, needs_transportation: true, start_date: t(9), target_end_date: t(13), notes: "Waiting on hardwood delivery before scheduling crew.", created_at: t(-15) + "T00:00:00.000Z", updated_at: nowIso + "T00:00:00.000Z" },
    { id: "p-5", company_id: COMPANY_ID, building_id: "b-9", unit_number: "3F", name: "Unit 3F — Laminate Installation", description: "Install laminate flooring throughout, 2BR unit, ~850 sq ft.", status: "In Progress", project_value: 5600, other_cost: 100, needs_transportation: true, start_date: t(-1), target_end_date: t(2), created_at: t(-18) + "T00:00:00.000Z", updated_at: nowIso + "T00:00:00.000Z" },
    { id: "p-6", company_id: COMPANY_ID, building_id: "b-13", unit_number: "Lobby", name: "Lobby Tile Renovation", description: "Demo existing terrazzo-look tile, install new porcelain tile in lobby.", status: "Pre-Construction", project_value: 14500, other_cost: 400, needs_transportation: true, start_date: t(14), target_end_date: t(21), notes: "Board approved design, awaiting material lead time.", created_at: t(-25) + "T00:00:00.000Z", updated_at: nowIso + "T00:00:00.000Z" },
    { id: "p-7", company_id: COMPANY_ID, building_id: "b-17", unit_number: "2B", name: "Unit 2B — Carpet Replacement", description: "Full carpet replacement, 2BR unit, builder-grade to mid-grade upgrade.", status: "Completed", project_value: 3200, other_cost: 0, needs_transportation: false, start_date: t(-12), target_end_date: t(-10), actual_end_date: t(-10), created_at: t(-40) + "T00:00:00.000Z", updated_at: t(-10) + "T00:00:00.000Z" },
    { id: "p-8", company_id: COMPANY_ID, building_id: "b-3", unit_number: "9D", name: "Unit 9D — Hardwood Sand & Finish", description: "Sand and refinish existing hardwood, natural stain, water-based poly.", status: "Punch List", project_value: 4800, other_cost: 0, needs_transportation: true, start_date: t(-6), target_end_date: t(-1), notes: "Minor touch-up needed at threshold to kitchen.", created_at: t(-30) + "T00:00:00.000Z", updated_at: nowIso + "T00:00:00.000Z" },
    { id: "p-9", company_id: COMPANY_ID, building_id: "b-7", unit_number: "15A", name: "Unit 15A — LVP Installation", description: "LVP install, 700 sq ft, includes furniture moving.", status: "Approved", project_value: 4900, other_cost: 0, needs_transportation: true, start_date: t(3), target_end_date: t(4), created_at: t(-5) + "T00:00:00.000Z", updated_at: nowIso + "T00:00:00.000Z" },
    { id: "p-10", company_id: COMPANY_ID, building_id: "b-11", unit_number: "6C", name: "Unit 6C — Subfloor Repair + LVP", description: "Repair water-damaged subfloor section, then install LVP throughout.", status: "Materials Required", project_value: 6700, other_cost: 300, needs_transportation: true, start_date: t(10), target_end_date: t(12), notes: "Subfloor plywood needs to be ordered before scheduling.", created_at: t(-7) + "T00:00:00.000Z", updated_at: nowIso + "T00:00:00.000Z" },
    { id: "p-11", company_id: COMPANY_ID, building_id: "b-14", unit_number: "Common Area", name: "Common Area Demo + Tile", description: "Demolish old vinyl composite tile in common area, install new porcelain tile.", status: "In Progress", project_value: 11800, other_cost: 250, needs_transportation: true, start_date: t(-3), target_end_date: t(4), notes: "Large debris haul-out required daily — driver essential every day.", created_at: t(-22) + "T00:00:00.000Z", updated_at: nowIso + "T00:00:00.000Z" },
    { id: "p-12", company_id: COMPANY_ID, building_id: "b-19", unit_number: "1A", name: "Unit 1A — Baseboard / Trim Replacement", description: "Replace baseboards throughout after flooring install, paint-grade.", status: "Invoiced", project_value: 1800, other_cost: 0, needs_transportation: false, start_date: t(-9), target_end_date: t(-8), actual_end_date: t(-8), created_at: t(-35) + "T00:00:00.000Z", updated_at: t(-8) + "T00:00:00.000Z" },
