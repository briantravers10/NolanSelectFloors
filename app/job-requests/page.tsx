...
export default async function JobRequestsPage({ searchParams }: { searchParams: Promise<{ status?: string }> }) {
  ...
  return (
    <div>
      <PageHeader
        title="Job Requests"
        subtitle="Incoming work from management companies, from first call to ready-to-schedule."
