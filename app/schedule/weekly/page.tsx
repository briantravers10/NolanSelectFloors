                  ...
                  .map((e) => (
                    <tr key={e.projectId} className="border-b border-slate-100 last:border-0 align-top">
                      <td className="py-2 pr-2">
                        <Link href={`/projects/${e.projectId}`} className="font-medium text-sky-700 hover:underline">{e.name}</Link>
                      ...
                      <td className="py-2 pr-2 text-slate-700 text-xs">{[...e.crew].join(" / ") || "—"}</td>
